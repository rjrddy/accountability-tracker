...
export type MobileTab = "today" | "progress" | "friends" | "settings";
...
export default function MobileTabs({ activeTab, onChange }: MobileTabsProps) {
  return (
    <nav className="mb-4 rounded-lg border border-slate-200 bg-white p-1 shadow-sm" aria-label="App sections">
